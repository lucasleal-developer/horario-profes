...
try {
  ...
  execSync('esbuild server/*.ts --bundle --platform=node --target=node18 --format=esm --outdir=dist/server --alias:@shared=./shared --external:lightningcss --external:@babel/preset-typescript --external:@babel/preset-typescript/package.json --external:mysql2 --external:mysql2/promise', { stdio: 'inherit' });
